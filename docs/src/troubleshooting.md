...
[discuss with us](https://github.com/MineralsCloud/EquationsOfStateOfSolidsFitting.jl/discussions).

If you have additional tips, please either
[report an issue](https://github.com/MineralsCloud/EquationsOfStateOfSolidsFitting.jl/issues/new) or
[submit a PR](https://github.com/MineralsCloud/EquationsOfStateOfSolidsFitting.jl/compare) with suggestions.
...
## Loading EquationsOfStateOfSolidsFitting
